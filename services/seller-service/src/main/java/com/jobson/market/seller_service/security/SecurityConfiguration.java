package com.jobson.market.seller_service.security;
        ...
        .authorizeHttpRequests(
            requests ->
                requests
                    ...
                    .permitAll()
                    .requestMatchers("/sellers/{sellerId}/approve", "/sellers/{sellerId}/reject")
                    .hasAnyRole("ADMIN", "SUPER_ADMIN")
                    .requestMatchers("/sellers/**", "/sellers")
                    .hasAnyRole("SELLER_OWNER", "SELLER_STAFF", "ADMIN", "SUPER_ADMIN")
                    .anyRequest()
                    .authenticated())
